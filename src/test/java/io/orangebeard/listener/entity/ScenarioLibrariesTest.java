...
public class ScenarioLibrariesTest {
    ...
    public void test() {
        ...
        scenarioLibraries.add(List.of(new WikiPageDummy("name", scenarioLibraryHtml, null)));

        assertThat(scenarioLibraries.contains("<table class=\"toolchainTable scenarioTable\">\n" +
    ...
    private final String scenarioLibraryHtml = "<table class=\"toolchainTable scenarioTable\">\n" +
            "    <tr class=\"slimRowTitle\">\n" +
            "        <td>scenario</td>\n" +
            "        <td colspan=\"3\">dit is een scenario</td>\n" +
            "    </tr>\n" +
